import itertools
from lib.nl4dv.vlgenie import VLGenie
from lib.nl4dv.visgenie.vis_recos import vis_design_combos
...
class VisGenie:
    ...
    def extract_vis_type(self, query_ngrams):
        # print('vis_keyword_map:', self.nl4dv_instance.vis_keyword_map)

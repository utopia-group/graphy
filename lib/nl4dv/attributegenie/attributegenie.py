from lib.nl4dv.utils import constants, helpers
import copy
import nltk
...
class AttributeGenie:
    ...
    def extract_attributes(self, query_ngrams):
        ...
        # print("keyword_attribute_mapping:", self.nl4dv_instance.keyword_attribute_mapping)
        # print("query_attributes: ", query_attributes)
        # print("data attributes:", data_attributes)
        # print("attribute_aliases:", attribute_aliases)
        ...
        # print("query_attributes2:", query_attributes)

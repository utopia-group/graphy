...
# NL4DV Imports
from lib.nl4dv.datagenie import DataGenie
from lib.nl4dv.querygenie import QueryGenie
from lib.nl4dv.attributegenie import AttributeGenie
from lib.nl4dv.taskgenie import TaskGenie
from lib.nl4dv.visgenie import VisGenie
from lib.nl4dv.utils import helpers, constants, error_codes
...
class NL4DV:
    ...
    def analyze_query(self, query=None, dialog=None, debug=None, verbose=None):
        ...
        helpers.cond_print('Explicit Vis Utterances:' + str(self.extracted_vis_type) + ',' + str(self.extracted_vis_token), self.verbose)
        ...
        helpers.cond_print('extracted_tasks: ' + str(self.extracted_tasks), self.verbose)
        ...
        helpers.cond_print('output: ' + str(output), self.verbose)
        # print(len(output['visList']))
    ...
    # Sets the Dataset
    def set_data(self, data_url=None, data_value=None, dataname=None):
        return self.data_genie_instance.set_data(data_url=data_url, data_value=data_value, dataname=dataname)

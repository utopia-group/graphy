...
from lib.nlp.TabularSemanticParsing.src.data_processor.processor_utils import WIKISQL
import lib.nlp.TabularSemanticParsing.src.data_processor.vectorizers as vec
from lib.nlp.TabularSemanticParsing.src.eval.eval_utils import *
import lib.nlp.TabularSemanticParsing.src.eval.spider.evaluate as spider_eval_tools
import lib.nlp.TabularSemanticParsing.src.eval.wikisql.evaluate as wikisql_eval_tools
from lib.nlp.TabularSemanticParsing.src.data_processor.processor_utils import SPIDER
from lib.nlp.TabularSemanticParsing.src.eval.spider.syntaxsql import SQLSerializer
from lib.nlp.TabularSemanticParsing.src.utils.utils import encode_str_list, list_to_hist

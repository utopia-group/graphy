...
# hacky workaround
parser.add_argument('--check_baseline', action='store_true', default=False)
parser.add_argument("--test_set", type=str, default="car", help="the test set")
...
parser.add_argument('--ts', type=str, default=None, help='timestamp for output saving')

# separate all model lr and epoch
parser.add_argument('--plot_epochs', type=int, default=20)
parser.add_argument('--plot_lr', type=float, default=.00002)
parser.add_argument('--plot_wr', type=float, default=.05)
parser.add_argument('--color_epochs', type=int, default=20)
parser.add_argument('--color_lr', type=float, default=.00002)
parser.add_argument('--color_wr', type=float, default=.05)
parser.add_argument('--column_epochs', type=int, default=20)
parser.add_argument('--column_lr', type=float, default=.00002)
parser.add_argument('--column_wr', type=float, default=.05)
parser.add_argument('--count_epochs', type=int, default=20)
parser.add_argument('--count_lr', type=float, default=.00002)
parser.add_argument('--count_wr', type=float, default=.05)
parser.add_argument('--mean_epochs', type=int, default=20)
parser.add_argument('--mean_lr', type=float, default=.00002)
parser.add_argument('--mean_wr', type=float, default=.05)
parser.add_argument('--sum_epochs', type=int, default=20)
parser.add_argument('--sum_lr', type=float, default=.00002)
parser.add_argument('--sum_wr', type=float, default=.05)
...
parser.add_argument('--hidden_size', type=int, default=150, help='hidden state dimensionality')

parser.add_argument('--max_field_num', type=int, default=10, help='max number of field allowed per benchmark')
parser.add_argument('--max_token_num_per_field', type=int, default=5, help='max number of token per field allowed')

...
import lib.nlp.TabularSemanticParsing.src.data_processor.processor_utils as data_utils
from lib.nlp.TabularSemanticParsing.src.data_processor.schema_graph import SchemaGraphs
from lib.nlp.TabularSemanticParsing.src.data_processor.schema_loader import load_schema_graphs
from lib.nlp.TabularSemanticParsing.src.data_processor.path_utils import get_checkpoint_path
from lib.nlp.TabularSemanticParsing.src.data_processor.processors.data_processor_spider import preprocess_example
import lib.nlp.TabularSemanticParsing.src.data_processor.schema_loader as schema_loader
import lib.nlp.TabularSemanticParsing.src.data_processor.tokenizers as tok
from lib.nlp.TabularSemanticParsing.src.semantic_parser.learn_framework import EncoderDecoderLFramework
from lib.nlp.TabularSemanticParsing.src.trans_checker.trans_checker import TranslatabilityChecker
from lib.nlp.TabularSemanticParsing.src.utils.utils import model_index
from lib.nlp.TabularSemanticParsing.src.utils.utils import BRIDGE
...
class Text2SQLWrapper(object):
    ...
    def translate(self, example):
        ...
        if len(output['pred_decoded'][0]) > 1:
            ...
            pred_sql = None
        # print("translate output:", output['pred_decoded'])
        print('inference time: {:.2f}s'.format(time.time() - start_time))
        return pred_sql, output['pred_decoded']

...
import lib.nlp.TabularSemanticParsing.src.common.content_encoder as ce
from lib.nlp.TabularSemanticParsing.src.data_processor.sql.sql_operators import field_types
from lib.nlp.TabularSemanticParsing.src.data_processor.vocab_utils import Vocabulary
from lib.nlp.TabularSemanticParsing.src.utils.utils import deprecated
...
class SchemaGraph(object):
    ...
    def load_data_from_csv_file(self, in_csv, field_type_file=None):
        ...
        with open(in_csv) as f:
            ...
            # table_header = [x.replace(' ', '') for x in table_header]

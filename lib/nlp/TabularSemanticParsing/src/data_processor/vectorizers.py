...
from lib.nlp.TabularSemanticParsing.moz_sp.sql_tokenizer import TABLE, FIELD, RESERVED_TOKEN, VALUE
from lib.nlp.TabularSemanticParsing.src.data_processor.sql.sql_reserved_tokens import digits

...
from lib.nlp.TabularSemanticParsing.moz_sp.debugs import debug, DEBUG
from lib.nlp.TabularSemanticParsing.moz_sp.keywords import AND, AS, ASC, BETWEEN, CASE, COLLATE_NOCASE, CROSS_JOIN, \
    DESC, ELSE, END, FROM, \

...
config = {
    ...
    "inline_data": False,
    "dataset_url": "https://aqua-data.github.io/data/wikisql1.1/",
...
table_name = "wikisql_2-11867-3"

random.seed(2020)

parser = argparse.ArgumentParser(description="Draco visualization synthesis.")
parser.add_argument("--input_dir", default="../../wikisql-full", help="Input directory containing tables and fine types.")
parser.add_argument("--output_dir", default="../../vis-viewer/sample-outputs/wikisql-full", help="The output directory.")

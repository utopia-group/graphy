...
"""
eval engine for the variant with no table property constraint  
"""


class EvalSynthNoTable(EvalEngine):
    ...
    def __init__(self, timeout=300, k=10):
        ...
        grammar = TypedCFG()
        self.synthesizer = TopLevelSynthesizerNoQualifier(QueryNeuralParser(args), ProgramSynthesizerNoQualifier(grammar, no_provenance=False, no_table=True),
                                                          timeout=timeout, no_provenance=False, no_table=True)

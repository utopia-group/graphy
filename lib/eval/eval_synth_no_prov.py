...
"""
eval engine for the variant with no provenance constraint  
"""


class EvalSynthNoProv(EvalEngine):
    ...
    def __init__(self, timeout=300, k=10):
        ...
        grammar = TypedCFG()
        self.synthesizer = TopLevelSynthesizerNoQualifier(QueryNeuralParser(args), ProgramSynthesizerNoQualifier(grammar, no_provenance=True, no_table=False),
                                                          timeout=timeout, no_provenance=True, no_table=False)
